...
/* Liquid Glass Search Bar Styles - Inline Version (Darker) */
.search-liquid-glass {
  width: 100%;
  max-width: 600px;
  background-color: rgba(0, 0, 0, 0.4); /* Darker background */
  backdrop-filter: blur(25px) saturate(150%); /* Adjusted for darker effect */
  -webkit-backdrop-filter: blur(25px) saturate(150%); /* Adjusted for darker effect */
  border-radius: 13px;
  border: 1px solid rgba(255, 255, 255, 0.5); /* Darker border */
...
```css
/* Liquid Glass Notification Styles - Floating Version (Darker) */
...
```css
/* Liquid Glass Notification Styles - Inline Version (Darker) */
.liquid-glass-notification {
